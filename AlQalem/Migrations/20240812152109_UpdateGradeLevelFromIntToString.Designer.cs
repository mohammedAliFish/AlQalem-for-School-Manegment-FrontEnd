...
namespace AlQalem.Migrations
{
    ...
    [Migration("20240812152109_UpdateGradeLevelFromIntToString")]
    partial class UpdateGradeLevelFromIntToString
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AlQalem.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            RoleId = new Guid("adb08d00-e616-41ea-a09e-064a280a5b49"),
                            Name = "Admin"
                        },
                        new
                        {
                            RoleId = new Guid("d7e01179-b3a6-4085-a77a-c7e7b56f8fa1"),
                            Name = "Teacher"
                        },
                        new
                        {
                            RoleId = new Guid("3b9557cf-f7a5-46a7-b4ac-af51eb057c75"),
                            Name = "Student"
                        },
                        new
                        {
